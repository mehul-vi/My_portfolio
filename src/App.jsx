  ...
  return (
    <div className="min-h-screen bg-[#0A0A0C] text-[#F4F4F5] font-sans antialiased selection:bg-white/10 overflow-x-clip relative">
      ...
      <div className="fixed bottom-8 right-8 z-45 flex flex-col gap-3.5">
        ...
        <div className="group relative flex items-center justify-end">
          <span className="absolute right-14 px-3 py-1.5 bg-zinc-950/90 border border-zinc-900 text-blue-400 text-[10px] font-mono font-bold rounded-lg opacity-0 pointer-events-none group-hover:opacity-100 group-hover:translate-x-[-4px] transition-all duration-300 shadow-xl whitespace-nowrap tracking-wide">
            LinkedIn Profile
          </span>
          <motion.a
            href="https://www.linkedin.com/in/mehul-kumar-sahu"
            target="_blank"
            rel="noreferrer"
            className="w-12 h-12 rounded-full border border-blue-500/20 bg-zinc-950/80 backdrop-blur-md text-blue-400 hover:text-white hover:bg-blue-600 hover:border-blue-500 flex items-center justify-center shadow-lg transition-all duration-300 hover:shadow-[0_0_15px_rgba(59,130,246,0.4)] cursor-pointer"
            whileHover={{ y: -4, scale: 1.08 }}
            whileTap={{ scale: 0.94 }}
          >
            <Linkedin size={20} />
